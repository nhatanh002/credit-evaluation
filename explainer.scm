...
(require 'querier)
(module explainer *
	(import chicken scheme extras schelog database selector knowledgebase querier)
;;explainer
  ...
  (call/cc (lambda(return)
             (if (not (%which() (%ok-profile client 'ok)))
                 ...
                 (let* ((sug-ls (query-strip (%which (suggest)
                   ...
                   (newline)
                   (display "------------------------------------------\n")
                   (display "The suggestion for \[")
                   (display client)
                   (display "\] is \[")
                   (display sug)
                   (display "\] because:\n")
		   (newline)
                   (display "\tThe client has ok profile\n")
                   (display "\tThe client's collateral rating is \[")
                   (display coll)
                   (display "\]\n")
                   (display "\tThe client's financial rating is \[")
                   (display fin)
                   (display "\]\n")
                   (display "\tThe client's bank yield rating is \[")
                   (display yie)
                   (display "\]\n")
		   ...
		   (display "\t\tbank yield >= reasonable OR\n")
		   (display "\t\tCollateral rating >= good,\n")
		   (display "\t\tFinancial rating >= good,\n")
		   ...
		   (display "\t\tOtherwise, refuse-credit-request\n")
                   ...
                   (newline)
                   (display "------------------------------------------\n")
                   (display "\tThe client \[") (display client) (display "\]'s bank yield rating is \[")
                   (display yie)
                   (display "\] because:\n")
                   (display "\t The bank yield for this client is: ")
                   (display +yield)
                   (display "%")
